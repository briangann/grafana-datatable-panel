...
- BUGFIX: Compatibility for v5

## [0.0.5]

- BUGFIX: SystemJS path changes for Grafana > 4.6

## [0.0.4]

- NEW: Now autoscrolls horizontally if number of columns is wider than the rendered panel (issue #6)

## [0.0.3]

- BUGFIX: Saving State should now work - wrong option was in the datatable constructor
